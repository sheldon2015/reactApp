...
const router = <Route path='/' component={App}>
  <IndexRoute getComponent={(nextState, callback) => {
    require.ensure([], function(require) {
      callback(null, require('./../components/Home.jsx').default)
    })
  }}/>
  ...
  <Route path='investlist' getComponent={(nextState, callback) => {
    require.ensure([], function(require) {
      callback(null, require('./../components/Investlist.jsx').default)
    })
  }}/>
  ...
  <Route path='account' getComponent={(nextState, callback) => {
    require.ensure([], function(require) {
      callback(null, require('./../components/Account.jsx').default)
    })
  }}/>
  <Route path='yilule' getComponent={(nextState, callback) => {
    require.ensure([], function(require) {
      callback(null, require('./../components/Yilule.jsx').default)
    })
  }}/>
